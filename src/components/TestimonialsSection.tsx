  ...
  const testimonials = [
    {
      ...
      text: "Бісив мене цей контент, але з вашим підходом все спростилось. Забуваю зранку продумати, як зфоткати. вже як працюю думаю що в кінці зніму. А ще хочу подякувати за фото на підсвіченому фоні, сторінка стала гарна, як не моя",
    },
    {
      image: testimonials_2,
      text: "Я все не могла понять почему у меня не так выходит фото, все какое-то грязное, без вкуса. А теперь значительно лучше и контент при этом намного быстрее делаю. Еле не могу себя приучить писать контент план. Но это я думаю с опытом прийдет",
    },
    {
      image: testimonials_3,
      text: "Дуже дякую за цей курс. Особливо що я можу використати це. Бачила багато порад але то фотоапарат, то Фотошоп треба, то багато всякого світла. А тут все для звичайного майстра",
    },
    {
      image: testimonials_4,
      text: "Все зрозуміла, вже застосовую. Добре, що він від майстра, бо враховує нашу специфіку",
    },
    {
      image: testimonials_5,
      text: "Все швидко, зрозуміло і простими словами. Дякую за цю інформацію",
    },
    {
