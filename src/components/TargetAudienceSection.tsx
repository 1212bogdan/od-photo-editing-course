          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <div className="space-y-3 text-sm sm:text-base text-card-foreground">
                <p>
                  Ти робиш якісну роботу, але фото не передає через екран як
                  вона виглядає "в живу" і не приваблює нових клієнтів. Твій
                  візуальний стиль далекий від того, що ти бачиш на сторінках
                  популярних майстрів твого міста.
                </p>
                <p>
                  Стомилась платити за ретуш, яка виглядає "пластмасовою", маєш
                  власне бачення.
                </p>
                <p>
                  Хочеш нарешті робити якісний контент своїми силами і при цьому
            ...
            <div className="border-t border-glass pt-4 sm:pt-6">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-primary mb-3 sm:mb-4">
                А Й ДЛЯ ВСІХ, ХТО ХОЧЕ ПРОСТО ЗАРАЗ НАВЧИТИСЬ ШВИДКО СТВОРЮВАТИ
                ТА РЕДАГУВАТИ 📸&nbsp;ФОТО 🎬&nbsp;ВІДЕО КОНТЕНТ
              </h3>
              ...
              <div className="space-y-3 text-sm sm:text-base text-card-foreground">
                <p>
                  Якщо ти не майстер перманенту, але твоя робота тісно пов'язана
                  з б'юті або ти тільки починаєш свій шлях як SMM для майстрів.
                </p>
                <p>
                  Чи просто хочеш для себе навчитись обробляти фото - в цьому
                  курсі ти навчишся робити це швидко та без зайвих витрат.
                </p>
              </div>
            </div>
          </div>
